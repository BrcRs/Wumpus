 ...
 *
 */
public final class MyConfigurationFile {
	...
	public static String INSTANCE_TOPOLOGY="resources/topology/map2018-topology-ica"; // fav
	...
	public static String INSTANCE_CONFIGURATION_ELEMENTS="resources/distributedExploration/emptyMap"; // fav
...
//	public static String INSTANCE_CONFIGURATION_ENTITIES="resources/agentFSMExplo-2-Wumpus"; // fav
//	public static String INSTANCE_CONFIGURATION_ENTITIES="resources/agentFSMExplo-2-Wumpus-1stench";
	public static String INSTANCE_CONFIGURATION_ENTITIES="resources/agentFSMExplo-2-Ctrl-1stench";
	//public static String INSTANCE_CONFIGURATION_ENTITIES="resources/agentFSMExplo-3-Wumpus";
